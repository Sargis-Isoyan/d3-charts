    ...
    [          '$stateProvider', '$urlRouterProvider', 'JQ_CONFIG', 'MODULE_CONFIG', 
      function ($stateProvider,   $urlRouterProvider, JQ_CONFIG, MODULE_CONFIG) {
          ...
          $stateProvider
              ...
              .state('app.dashboard-color', {
                  url: '/dashboard-color',
                  templateUrl: 'tpl/app_dashboard_color.html',
                  resolve: load(['js/controllers/chart.js'])
              })
              .state('app.dashboard-historicurrentchart', {
                  url: '/dashboard-historicurrentchart',
                  templateUrl: 'tpl/app_dashboard_historicurrentchart.html',
                  resolve: load(['js/controllers/historicurrentchart.js'])
              })
              .state('app.dashboard-pricepoint', {
                  url: '/dashboard-pricepoint',
                  templateUrl: 'tpl/app_dashboard_pricepoint.html',
                  resolve: load(['js/controllers/pricepoint.js'])
              })
              .state('app.dashboard-discount', {
                  url: '/dashboard-discount',
                  templateUrl: 'tpl/app_dashboard_discount.html',
                  resolve: load(['js/controllers/discount.js'])
              })
              .state('app.dashboard-discountbyplayer', {
                  url: '/dashboard-discountbyplayer',
                  templateUrl: 'tpl/app_dashboard_dicountbyplayer.html',
                  resolve: load(['js/controllers/discountbyplayer.js'])
              })
              .state('app.dashboard-discounteffortbycat', {
                  url: '/dashboard-discounteffortbycat',
                  templateUrl: 'tpl/app_dashboard_discounteffortbycat.html',
                  resolve: load(['js/controllers/discounteffortbycat.js'])
              })
              .state('app.dashboard-storenetworksize', {
                  url: '/dashboard-storenetworksize',
                  templateUrl: 'tpl/app_dashboard_storenetworksize.html',
                  resolve: load(['js/controllers/storenetworksize.js'])
              })
              .state('app.dashboard-pricestatistic', {
                  url: '/dashboard-pricestatistic',
                  templateUrl: 'tpl/app_dashboard_pricestatistic.html',
                  resolve: load(['js/controllers/priceStatistic.js'])
              })
              .state('app.ui', {
                  url: '/ui',
